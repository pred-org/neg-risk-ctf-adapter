...
The NegRiskOperator is a permissioned controller for interacting with the NegRiskAdapter. The NegRiskOperator serves as the creator and maintainer for PRED's neg risk markets and questions.
