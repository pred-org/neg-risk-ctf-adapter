...
- The `NegRiskCtfExchange` is a lightweight fork of PRED's exchange contract: (https://github.com/pred-org/ctf-exchange)[https://github.com/pred-org/ctf-exchange]. It is designed to be enable trading with PRED's CLOB in NegRisk markets.
- The `NegRiskFeeModule` is a lightweight fork of PRED's fee module: (https://github.com/pred-org/exchange-fee-module)[https://github.com/pred-org/exchange-fee-module]. It is designed to be used with the NegRiskCtfExchange.
