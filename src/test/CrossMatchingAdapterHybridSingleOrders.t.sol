...
contract CrossMatchingAdapterHybridSingleOrdersTest is Test, TestHelper {
    ...
    function testSingleOrdersMergeOneTest() public {
      ...
      assertEq(ctf.balanceOf(user1, yesPositionId), initialUser1YES - makerFillAmounts[0], "User1 should have sold YES tokens");
    ...
    function testSingleOrdersComplementaryOneTest() public {
      ...
      assertEq(ctf.balanceOf(user1, noPositionId), makerFillAmounts[0] * makerOrders[0].orders[0].takerAmount / makerOrders[0].orders[0].makerAmount, "User1 should receive NO tokens from maker order");
      ...
      assertEq(usdc.balanceOf(user1), initialUser1USDC - makerFillAmounts[0], "User1 should pay USDC for buying NO tokens");
      console.log("User1 USDC: %s", usdc.balanceOf(user1));
    ...
    function testSingleOrdersMintOneTest() public {
      ...
      assertEq(ctf.balanceOf(user1, yesPositionId), makerFillAmounts[0] * makerOrders[0].orders[0].takerAmount / makerOrders[0].orders[0].makerAmount, "User1 should receive YES tokens from maker order");
      console.log("User1 YES tokens: %s", ctf.balanceOf(user1, yesPositionId));
      ...
      assertEq(usdc.balanceOf(user1), initialUser1USDC - makerFillAmounts[0], "User1 should pay USDC for buying YES tokens");
      console.log("User1 USDC: %s", usdc.balanceOf(user1));
    ...
    function testSingleOrdersComplementaryMultipleTest() public {
      ...
      for (uint256 i = 0; i < 3; i++) {
        ...
        assertEq(ctf.balanceOf(maker, noPositionId), makerFillAmounts[i] * makerOrders[i].orders[0].takerAmount / makerOrders[i].orders[0].makerAmount, 
      ...
      for (uint256 i = 0; i < 3; i++) {
        ...
        assertEq(usdc.balanceOf(maker), initialMakerUSDC[i] - makerFillAmounts[i], 
    ...
    function testSingleOrdersMintMultipleTest() public {
      ...
      for (uint256 i = 0; i < 3; i++) {
        ...
        assertEq(ctf.balanceOf(maker, yesPositionId), makerFillAmounts[i] * makerOrders[i].orders[0].takerAmount / makerOrders[i].orders[0].makerAmount, 
